...
async function checkPlaceholders() {
  const templatePath = path.join(__dirname, 'backend-templates', 'slack-to-teams-advanced.docx');
  
  console.log('🔍 Checking placeholders in Slack to Teams Advanced template...\n');
