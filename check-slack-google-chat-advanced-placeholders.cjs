...
async function checkPlaceholders() {
  const templatePath = path.join(__dirname, 'backend-templates', 'slack-to-google-chat-advanced.docx');
  
  console.log('🔍 Checking placeholders in Slack to Google Chat Advanced template...\n');
