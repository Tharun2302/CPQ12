...
### Person A & Person B (Full-Stack Developers)
- **Work Style:** Both work on **all features** (frontend + backend in parallel)
- **Tech Stack:** Full stack (React, Vite, Node.js/Express, MongoDB, Mongoose, etc.)
- **Collaboration:**
  - No strict frontend/backend split
  - Both work on any feature from start to finish
  - Features owned by whoever starts the work
  - Code reviewed by the other person
- **Communication:** Daily standup 10 AM, PR review within 4 hours, blocking issues immediate
- **Workflow:**
  - Daily: Standup, code reviews, collaboration
  - Features: One person codes, other reviews
  - Deployment: Both coordinate on timing
  - Bugs: Whoever finds it, both help fix
