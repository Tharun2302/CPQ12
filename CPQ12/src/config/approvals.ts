...
export const APPROVAL_TECH_EMAIL = 'cpq.zenop.ai.technical@cloudfuze.com';
export const APPROVAL_LEGAL_EMAIL = 'cpq.zenop.ai.legal@cloudfuze.com';
export const APPROVAL_DEALDESK_EMAIL = 'salesops@cloudfuze.com';
