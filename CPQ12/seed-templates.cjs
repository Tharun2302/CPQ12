...
async function seedDefaultTemplates(db) {
  ...
  const defaultTemplates = [
    ...
    // EMAIL TEMPLATES
    // NOTE: Email migration type in UI uses combination slug `gmail-to-gmail`.
    ...
    // DROPBOX TO SHAREPOINT templates (Standard & Advanced only)
    {
      ...
      description: 'Basic template for Dropbox to SharePoint migration - suitable for medium to large projects',
    ...
    },
    {
      ...
      description: 'Standard template for Dropbox to SharePoint migration - suitable for large enterprise projects',
      fileName: 'dropbox-to-sharepoint-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'dropbox-to-sharepoint',
      planType: 'standard',
      keywords: ['standard', 'dropbox', 'sharepoint', 'content', 'microsoft', 'enterprise']
    },
    // DROPBOX TO ONEDRIVE templates (Standard & Advanced only)
    {
      name: 'DROPBOX TO ONEDRIVE Basic',
      description: 'Basic template for Dropbox to OneDrive migration - suitable for medium to large projects',
    ...
    },
    {
      ...
      description: 'Standard template for Dropbox to OneDrive migration - suitable for large enterprise projects',
      fileName: 'dropbox-to-onedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'dropbox-to-onedrive',
      planType: 'standard',
      keywords: ['standard', 'dropbox', 'onedrive', 'content', 'microsoft', 'enterprise']
    },
    // DROPBOX TO GOOGLE templates (Standard & Advanced only)
    {
      name: 'DROPBOX TO GOOGLE Basic',
      description: 'Basic template for Dropbox to Google migration - suitable for medium to large projects',
      fileName: 'dropbox-to-google-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'dropbox-to-google',
      planType: 'basic',
      keywords: ['basic', 'dropbox', 'google', 'content', 'migration']
    },
    {
      name: 'DROPBOX TO GOOGLE Standard',
      description: 'Standard template for Dropbox to Google migration - suitable for large enterprise projects',
      fileName: 'dropbox-to-google-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'dropbox-to-google',
      planType: 'standard',
      keywords: ['standard', 'dropbox', 'google', 'content', 'migration', 'enterprise']
    },
    // DROPBOX TO MICROSOFT templates (Standard & Advanced only)
    {
      name: 'DROPBOX TO MICROSOFT Basic',
      description: 'Basic template for Dropbox to Microsoft migration - suitable for medium to large projects',
      fileName: 'dropbox-to-microsoft-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'dropbox-to-microsoft',
      planType: 'basic',
      keywords: ['basic', 'dropbox', 'microsoft', 'content', 'migration']
    },
    {
      name: 'DROPBOX TO MICROSOFT Standard',
      description: 'Standard template for Dropbox to Microsoft migration - suitable for large enterprise projects',
      fileName: 'dropbox-to-microsoft-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'dropbox-to-microsoft',
      planType: 'standard',
      keywords: ['standard', 'dropbox', 'microsoft', 'content', 'migration', 'enterprise']
    },
    // DROPBOX TO BOX templates (Standard & Advanced only)
    {
      name: 'DROPBOX TO BOX Basic',
      description: 'Basic template for Dropbox to Box migration - suitable for medium to large projects',
      fileName: 'dropbox-to-box-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'dropbox-to-box',
      planType: 'basic',
      keywords: ['basic', 'dropbox', 'box', 'content', 'migration']
    },
    {
      name: 'DROPBOX TO BOX Standard',
      description: 'Standard template for Dropbox to Box migration - suitable for large enterprise projects',
      fileName: 'dropbox-to-box-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'dropbox-to-box',
      planType: 'standard',
      keywords: ['standard', 'dropbox', 'box', 'content', 'migration', 'enterprise']
    },
    // DROPBOX TO EGNYTE templates (Standard & Advanced only)
    {
      name: 'DROPBOX TO EGNYTE Basic',
      description: 'Basic template for Dropbox to Egnyte migration - suitable for medium to large projects',
      fileName: 'dropbox-to-egnyte-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'dropbox-to-egnyte',
      planType: 'basic',
      keywords: ['basic', 'dropbox', 'egnyte', 'content', 'migration']
    },
    {
      name: 'DROPBOX TO EGNYTE Standard',
      description: 'Standard template for Dropbox to Egnyte migration - suitable for large enterprise projects',
      fileName: 'dropbox-to-egnyte-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'dropbox-to-egnyte',
      planType: 'standard',
      keywords: ['standard', 'dropbox', 'egnyte', 'content', 'migration', 'enterprise']
    },
    // BOX TO BOX templates (Standard & Advanced only)
    {
      name: 'BOX TO BOX Basic',
      description: 'Basic template for Box to Box migration - suitable for medium to large projects',
      fileName: 'box-to-box-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-box',
      planType: 'basic',
      keywords: ['basic', 'box', 'content', 'migration']
    },
    {
      name: 'BOX TO BOX Standard',
      description: 'Standard template for Box to Box migration - suitable for large enterprise projects',
      fileName: 'box-to-box-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-box',
      planType: 'standard',
      keywords: ['standard', 'box', 'content', 'migration', 'enterprise']
    },
    // BOX TO DROPBOX templates (Standard & Advanced only)
    {
      name: 'BOX TO DROPBOX Basic',
      description: 'Basic template for Box to Dropbox migration - suitable for medium to large projects',
      fileName: 'box-to-dropbox-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-dropbox',
      planType: 'basic',
      keywords: ['basic', 'box', 'dropbox', 'content', 'migration']
    },
    {
      name: 'BOX TO DROPBOX Standard',
      description: 'Standard template for Box to Dropbox migration - suitable for large enterprise projects',
      fileName: 'box-to-dropbox-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-dropbox',
      planType: 'standard',
      keywords: ['standard', 'box', 'dropbox', 'content', 'migration', 'enterprise']
    },
    // BOX TO SHAREFILE templates (Standard & Advanced only)
    {
      name: 'BOX TO SHAREFILE Basic',
      description: 'Basic template for Box to ShareFile migration - suitable for medium to large projects',
      fileName: 'box-to-sharefile-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-sharefile',
      planType: 'basic',
      keywords: ['basic', 'box', 'sharefile', 'content', 'migration']
    },
    {
      name: 'BOX TO SHAREFILE Standard',
      description: 'Standard template for Box to ShareFile migration - suitable for large enterprise projects',
      fileName: 'box-to-sharefile-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-sharefile',
      planType: 'standard',
      keywords: ['standard', 'box', 'sharefile', 'content', 'migration', 'enterprise']
    },
    // BOX TO SHAREPOINT templates (Standard & Advanced only)
    {
      name: 'BOX TO SHAREPOINT Basic',
      description: 'Basic template for Box to SharePoint migration - suitable for medium to large projects',
      fileName: 'box-to-sharepoint-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-sharepoint',
      planType: 'basic',
      keywords: ['basic', 'box', 'sharepoint', 'content', 'microsoft']
    },
    {
      name: 'BOX TO SHAREPOINT Standard',
      description: 'Standard template for Box to SharePoint migration - suitable for large enterprise projects',
      fileName: 'box-to-sharepoint-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-sharepoint',
      planType: 'standard',
      keywords: ['standard', 'box', 'sharepoint', 'content', 'microsoft', 'enterprise']
    },
    ...
    {
      name: 'BOX TO GOOGLE MYDRIVE Basic',
      description: 'Basic template for Box to Google MyDrive migration - suitable for medium to large projects',
      fileName: 'box-to-google-mydrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-google-mydrive',
      planType: 'basic',
      keywords: ['basic', 'box', 'google', 'mydrive', 'content', 'migration']
    },
    {
      name: 'BOX TO GOOGLE MYDRIVE Standard',
      description: 'Standard template for Box to Google MyDrive migration - suitable for large enterprise projects',
      fileName: 'box-to-google-mydrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-google-mydrive',
      planType: 'standard',
      keywords: ['standard', 'box', 'google', 'mydrive', 'content', 'migration', 'enterprise']
    },
    // BOX TO GOOGLE SHARED DRIVE templates (Standard & Advanced only)
    {
      name: 'BOX TO GOOGLE SHARED DRIVE Basic',
      description: 'Basic template for Box to Google Shared Drive migration - suitable for medium to large projects',
      fileName: 'box-to-google-sharedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-google-sharedrive',
      planType: 'basic',
      keywords: ['basic', 'box', 'google', 'sharedrive', 'shared drive', 'content', 'migration']
    },
    {
      name: 'BOX TO GOOGLE SHARED DRIVE Standard',
      description: 'Standard template for Box to Google Shared Drive migration - suitable for large enterprise projects',
      fileName: 'box-to-google-sharedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-google-sharedrive',
      planType: 'standard',
      keywords: ['standard', 'box', 'google', 'sharedrive', 'shared drive', 'content', 'migration', 'enterprise']
    },
    // BOX TO ONEDRIVE templates (Standard & Advanced only)
    {
      name: 'BOX TO ONEDRIVE Basic',
      description: 'Basic template for Box to OneDrive migration - suitable for medium to large projects',
      fileName: 'box-to-onedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-onedrive',
      planType: 'basic',
      keywords: ['basic', 'box', 'onedrive', 'microsoft', 'content', 'migration']
    },
    {
      name: 'BOX TO ONEDRIVE Standard',
      description: 'Standard template for Box to OneDrive migration - suitable for large enterprise projects',
      fileName: 'box-to-onedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-onedrive',
      planType: 'standard',
      keywords: ['standard', 'box', 'onedrive', 'microsoft', 'content', 'migration', 'enterprise']
    },
    // BOX TO MICROSOFT templates (Standard & Advanced only)
    {
      name: 'BOX TO MICROSOFT Basic',
      description: 'Basic template for Box to Microsoft migration - suitable for medium to large projects',
      fileName: 'box-to-microsoft-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-microsoft',
      planType: 'basic',
      keywords: ['basic', 'box', 'microsoft', 'content', 'migration']
    },
    {
      name: 'BOX TO MICROSOFT Standard',
      description: 'Standard template for Box to Microsoft migration - suitable for large enterprise projects',
      fileName: 'box-to-microsoft-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-microsoft',
      planType: 'standard',
      keywords: ['standard', 'box', 'microsoft', 'content', 'migration', 'enterprise']
    },
    // BOX TO GOOGLE templates (Standard & Advanced only)
    {
      name: 'BOX TO GOOGLE Basic',
      description: 'Basic template for Box to Google migration - suitable for medium to large projects',
      fileName: 'box-to-google-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-google',
      planType: 'basic',
      keywords: ['basic', 'box', 'google', 'content', 'migration']
    },
    {
      name: 'BOX TO GOOGLE Standard',
      description: 'Standard template for Box to Google migration - suitable for large enterprise projects',
      fileName: 'box-to-google-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'box-to-google',
      planType: 'standard',
      keywords: ['standard', 'box', 'google', 'content', 'migration', 'enterprise']
    },
    // GOOGLE SHARED DRIVE TO EGNYTE templates (Standard & Advanced only)
    {
      name: 'GOOGLE SHARED DRIVE TO EGNYTE Basic',
      description: 'Basic template for Google Shared Drive to Egnyte migration - suitable for medium to large projects',
      fileName: 'google-sharedrive-to-egnyte-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-sharedrive-to-egnyte',
      planType: 'basic',
      keywords: ['basic', 'google', 'sharedrive', 'egnyte', 'content', 'migration']
    },
    {
      name: 'GOOGLE SHARED DRIVE TO EGNYTE Standard',
      description: 'Standard template for Google Shared Drive to Egnyte migration - suitable for large enterprise projects',
      fileName: 'google-sharedrive-to-egnyte-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-sharedrive-to-egnyte',
      planType: 'standard',
      keywords: ['standard', 'google', 'sharedrive', 'egnyte', 'content', 'migration', 'enterprise']
    },
    // GOOGLE SHARED DRIVE TO GOOGLE SHARED DRIVE templates (Standard & Advanced only)
    {
      name: 'GOOGLE SHARED DRIVE TO GOOGLE SHARED DRIVE Basic',
      description: 'Basic template for Google Shared Drive to Google Shared Drive migration - suitable for medium to large projects',
      fileName: 'google-sharedrive-to-google-sharedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-sharedrive-to-google-sharedrive',
      planType: 'basic',
      keywords: ['basic', 'google', 'sharedrive', 'content', 'migration']
    },
    {
      name: 'GOOGLE SHARED DRIVE TO GOOGLE SHARED DRIVE Standard',
      description: 'Standard template for Google Shared Drive to Google Shared Drive migration - suitable for large enterprise projects',
      fileName: 'google-sharedrive-to-google-sharedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-sharedrive-to-google-sharedrive',
      planType: 'standard',
      keywords: ['standard', 'google', 'sharedrive', 'content', 'migration', 'enterprise']
    },
    // GOOGLE SHARED DRIVE TO ONEDRIVE templates (Standard & Advanced only)
    {
      name: 'GOOGLE SHARED DRIVE TO ONEDRIVE Basic',
      description: 'Basic template for Google Shared Drive to OneDrive migration - suitable for medium to large projects',
      fileName: 'google-sharedrive-to-onedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-sharedrive-to-onedrive',
      planType: 'basic',
      keywords: ['basic', 'google', 'sharedrive', 'onedrive', 'content', 'microsoft', 'migration']
    },
    {
      name: 'GOOGLE SHARED DRIVE TO ONEDRIVE Standard',
      description: 'Standard template for Google Shared Drive to OneDrive migration - suitable for large enterprise projects',
      fileName: 'google-sharedrive-to-onedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-sharedrive-to-onedrive',
      planType: 'standard',
      keywords: ['standard', 'google', 'sharedrive', 'onedrive', 'content', 'microsoft', 'migration', 'enterprise']
    },
    // GOOGLE SHARED DRIVE TO SHAREPOINT templates (Standard & Advanced only)
    {
      name: 'GOOGLE SHARED DRIVE TO SHAREPOINT Basic',
      description: 'Basic template for Google Shared Drive to SharePoint migration - suitable for medium to large projects',
      fileName: 'google-sharedrive-to-sharepoint-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-sharedrive-to-sharepoint',
      planType: 'basic',
      keywords: ['basic', 'google', 'sharedrive', 'sharepoint', 'content', 'microsoft', 'migration']
    },
    {
      name: 'GOOGLE SHARED DRIVE TO SHAREPOINT Standard',
      description: 'Standard template for Google Shared Drive to SharePoint migration - suitable for large enterprise projects',
      fileName: 'google-sharedrive-to-sharepoint-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-sharedrive-to-sharepoint',
      planType: 'standard',
      keywords: ['standard', 'google', 'sharedrive', 'sharepoint', 'content', 'microsoft', 'migration', 'enterprise']
    },
    // EGNYTE TO SHAREPOINT ONLINE templates (Standard & Advanced only)
    {
      name: 'EGNYTE TO SHAREPOINT ONLINE Basic',
      description: 'Basic template for Egnyte to SharePoint Online migration - suitable for medium to large projects',
      fileName: 'egnyte-to-sharepoint-online-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-sharepoint-online',
      planType: 'basic',
      keywords: ['basic', 'egnyte', 'sharepoint', 'online', 'content', 'migration', 'microsoft']
    },
    {
      name: 'EGNYTE TO SHAREPOINT ONLINE Standard',
      description: 'Standard template for Egnyte to SharePoint Online migration - suitable for large enterprise projects',
      fileName: 'egnyte-to-sharepoint-online-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-sharepoint-online',
      planType: 'standard',
      keywords: ['standard', 'egnyte', 'sharepoint', 'online', 'content', 'migration', 'microsoft', 'enterprise']
    },
    // SHAREPOINT ONLINE TO EGNYTE templates (Standard & Advanced only, Basic to be added later)
    {
      name: 'SHAREPOINT ONLINE TO EGNYTE Basic',
      description: 'Basic template for SharePoint Online to Egnyte migration - suitable for medium to large projects',
      fileName: 'sharepoint-online-to-egnyte-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharepoint-online-to-egnyte',
      planType: 'basic',
      keywords: ['basic', 'sharepoint', 'online', 'egnyte', 'content', 'migration', 'microsoft']
    },
    {
      name: 'SHAREPOINT ONLINE TO EGNYTE Standard',
      description: 'Standard template for SharePoint Online to Egnyte migration - suitable for large enterprise projects',
      fileName: 'sharepoint-online-to-egnyte-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharepoint-online-to-egnyte',
      planType: 'standard',
      keywords: ['standard', 'sharepoint', 'online', 'egnyte', 'content', 'migration', 'microsoft', 'enterprise']
    },
    // SHAREPOINT ONLINE TO GOOGLE MYDRIVE templates (Standard & Advanced only, Basic to be added later)
    {
      name: 'SHAREPOINT ONLINE TO GOOGLE MYDRIVE Basic',
      description: 'Basic template for SharePoint Online to Google MyDrive migration - suitable for medium to large projects',
      fileName: 'sharepoint-online-to-google-mydrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharepoint-online-to-google-mydrive',
      planType: 'basic',
      keywords: ['basic', 'sharepoint', 'online', 'google', 'mydrive', 'content', 'migration']
    },
    {
      name: 'SHAREPOINT ONLINE TO GOOGLE MYDRIVE Standard',
      description: 'Standard template for SharePoint Online to Google MyDrive migration - suitable for large enterprise projects',
      fileName: 'sharepoint-online-to-google-mydrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharepoint-online-to-google-mydrive',
      planType: 'standard',
      keywords: ['standard', 'sharepoint', 'online', 'google', 'mydrive', 'content', 'migration', 'enterprise']
    },
    // SHAREPOINT ONLINE TO GOOGLE SHARED DRIVE templates (Standard & Advanced only, Basic to be added later)
    {
      name: 'SHAREPOINT ONLINE TO GOOGLE SHARED DRIVE Basic',
      description: 'Basic template for SharePoint Online to Google Shared Drive migration - suitable for medium to large projects',
      fileName: 'sharepoint-online-to-google-sharedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharepoint-online-to-google-sharedrive',
      planType: 'basic',
      keywords: ['basic', 'sharepoint', 'online', 'google', 'sharedrive', 'shared drive', 'content', 'migration']
    },
    {
      name: 'SHAREPOINT ONLINE TO GOOGLE SHARED DRIVE Standard',
      description: 'Standard template for SharePoint Online to Google Shared Drive migration - suitable for large enterprise projects',
      fileName: 'sharepoint-online-to-google-sharedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharepoint-online-to-google-sharedrive',
      planType: 'standard',
      keywords: ['standard', 'sharepoint', 'online', 'google', 'sharedrive', 'shared drive', 'content', 'migration', 'enterprise']
    },
    // EGNYTE TO GOOGLE SHARED DRIVE templates (Standard & Advanced only)
    {
      name: 'EGNYTE TO GOOGLE SHARED DRIVE Basic',
      description: 'Basic template for Egnyte to Google Shared Drive migration - suitable for medium to large projects',
      fileName: 'egnyte-to-google-sharedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-google-sharedrive',
      planType: 'basic',
      keywords: ['basic', 'egnyte', 'google', 'sharedrive', 'content', 'migration']
    },
    {
      name: 'EGNYTE TO GOOGLE SHARED DRIVE Standard',
      description: 'Standard template for Egnyte to Google Shared Drive migration - suitable for large enterprise projects',
      fileName: 'egnyte-to-google-sharedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-google-sharedrive',
      planType: 'standard',
      keywords: ['standard', 'egnyte', 'google', 'sharedrive', 'content', 'migration', 'enterprise']
    },
    // EGNYTE TO GOOGLE MYDRIVE templates (Standard & Advanced only)
    {
      name: 'EGNYTE TO GOOGLE MYDRIVE Basic',
      description: 'Basic template for Egnyte to Google MyDrive migration - suitable for medium to large projects',
      fileName: 'egnyte-to-google-mydrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-google-mydrive',
      planType: 'basic',
      keywords: ['basic', 'egnyte', 'google', 'mydrive', 'content', 'migration']
    },
    {
      name: 'EGNYTE TO GOOGLE MYDRIVE Standard',
      description: 'Standard template for Egnyte to Google MyDrive migration - suitable for large enterprise projects',
      fileName: 'egnyte-to-google-mydrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-google-mydrive',
      planType: 'standard',
      keywords: ['standard', 'egnyte', 'google', 'mydrive', 'content', 'migration', 'enterprise']
    },
    // EGNYTE TO ONEDRIVE templates (Standard & Advanced only)
    {
      name: 'EGNYTE TO ONEDRIVE Basic',
      description: 'Basic template for Egnyte to OneDrive migration - suitable for medium to large projects',
      fileName: 'egnyte-to-onedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-onedrive',
      planType: 'basic',
      keywords: ['basic', 'egnyte', 'onedrive', 'microsoft', 'content', 'migration']
    },
    {
      name: 'EGNYTE TO ONEDRIVE Standard',
      description: 'Standard template for Egnyte to OneDrive migration - suitable for large enterprise projects',
      fileName: 'egnyte-to-onedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-onedrive',
      planType: 'standard',
      keywords: ['standard', 'egnyte', 'onedrive', 'microsoft', 'content', 'migration', 'enterprise']
    },
    // GOOGLE MYDRIVE TO DROPBOX templates (Standard & Advanced only)
    {
      name: 'GOOGLE MYDRIVE TO DROPBOX Basic',
      description: 'Basic template for Google MyDrive to Dropbox migration - suitable for medium to large projects',
      fileName: 'google-mydrive-to-dropbox-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-dropbox',
      planType: 'basic',
      keywords: ['basic', 'google', 'mydrive', 'dropbox', 'content', 'migration']
    },
    {
      name: 'GOOGLE MYDRIVE TO DROPBOX Standard',
      description: 'Standard template for Google MyDrive to Dropbox migration - suitable for large enterprise projects',
      fileName: 'google-mydrive-to-dropbox-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-dropbox',
      planType: 'standard',
      keywords: ['standard', 'google', 'mydrive', 'dropbox', 'content', 'migration', 'enterprise']
    },
    // GOOGLE MYDRIVE TO EGNYTE templates (Standard & Advanced only)
    {
      name: 'GOOGLE MYDRIVE TO EGNYTE Basic',
      description: 'Basic template for Google MyDrive to Egnyte migration - suitable for medium to large projects',
      fileName: 'google-mydrive-to-egnyte-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-egnyte',
      planType: 'basic',
      keywords: ['basic', 'google', 'mydrive', 'egnyte', 'content', 'migration']
    },
    {
      name: 'GOOGLE MYDRIVE TO EGNYTE Standard',
      description: 'Standard template for Google MyDrive to Egnyte migration - suitable for large enterprise projects',
      fileName: 'google-mydrive-to-egnyte-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-egnyte',
      planType: 'standard',
      keywords: ['standard', 'google', 'mydrive', 'egnyte', 'content', 'migration', 'enterprise']
    },
    // GOOGLE MYDRIVE TO ONEDRIVE templates (Standard & Advanced only)
    {
      name: 'GOOGLE MYDRIVE TO ONEDRIVE Basic',
      description: 'Basic template for Google MyDrive to OneDrive migration - suitable for medium to large projects',
      fileName: 'google-mydrive-to-onedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-onedrive',
      planType: 'basic',
      keywords: ['basic', 'google', 'mydrive', 'onedrive', 'content', 'microsoft', 'migration']
    },
    {
      name: 'GOOGLE MYDRIVE TO ONEDRIVE Standard',
      description: 'Standard template for Google MyDrive to OneDrive migration - suitable for large enterprise projects',
      fileName: 'google-mydrive-to-onedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-onedrive',
      planType: 'standard',
      keywords: ['standard', 'google', 'mydrive', 'onedrive', 'content', 'microsoft', 'migration', 'enterprise']
    },
    // GOOGLE MYDRIVE TO SHAREPOINT templates (Standard & Advanced only)
    {
      name: 'GOOGLE MYDRIVE TO SHAREPOINT Basic',
      description: 'Basic template for Google MyDrive to SharePoint migration - suitable for medium to large projects',
      fileName: 'google-mydrive-to-sharepoint-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-sharepoint',
      planType: 'basic',
      keywords: ['basic', 'google', 'mydrive', 'sharepoint', 'content', 'microsoft', 'migration']
    },
    {
      name: 'GOOGLE MYDRIVE TO SHAREPOINT Standard',
      description: 'Standard template for Google MyDrive to SharePoint migration - suitable for large enterprise projects',
      fileName: 'google-mydrive-to-sharepoint-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-sharepoint',
      planType: 'standard',
      keywords: ['standard', 'google', 'mydrive', 'sharepoint', 'content', 'microsoft', 'migration', 'enterprise']
    },
    // GOOGLE MYDRIVE TO GOOGLE SHARED DRIVE templates (Standard & Advanced only)
    {
      name: 'GOOGLE MYDRIVE TO GOOGLE SHARED DRIVE Basic',
      description: 'Basic template for Google MyDrive to Google Shared Drive migration - suitable for medium to large projects',
      fileName: 'google-mydrive-to-google-sharedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-google-sharedrive',
      planType: 'basic',
      keywords: ['basic', 'google', 'mydrive', 'sharedrive', 'content', 'migration']
    },
    {
      name: 'GOOGLE MYDRIVE TO GOOGLE SHARED DRIVE Standard',
      description: 'Standard template for Google MyDrive to Google Shared Drive migration - suitable for large enterprise projects',
      fileName: 'google-mydrive-to-google-sharedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-google-sharedrive',
      planType: 'standard',
      keywords: ['standard', 'google', 'mydrive', 'sharedrive', 'content', 'migration', 'enterprise']
    },
    // GOOGLE MYDRIVE TO GOOGLE MYDRIVE templates (Standard & Advanced only)
    {
      name: 'GOOGLE MYDRIVE TO GOOGLE MYDRIVE Basic',
      description: 'Basic template for Google MyDrive to Google MyDrive migration - suitable for medium to large projects',
      fileName: 'google-mydrive-to-google-mydrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-google-mydrive',
      planType: 'basic',
      keywords: ['basic', 'google', 'mydrive', 'content', 'migration']
    },
    {
      name: 'GOOGLE MYDRIVE TO GOOGLE MYDRIVE Standard',
      description: 'Standard template for Google MyDrive to Google MyDrive migration - suitable for large enterprise projects',
      fileName: 'google-mydrive-to-google-mydrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'google-mydrive-to-google-mydrive',
      planType: 'standard',
      keywords: ['standard', 'google', 'mydrive', 'content', 'migration', 'enterprise']
    },
    // ONEDRIVE TO GOOGLE MYDRIVE templates (Standard & Advanced only, Basic to be added later)
    {
      name: 'ONEDRIVE TO GOOGLE MYDRIVE Basic',
      description: 'Basic template for OneDrive to Google MyDrive migration - suitable for medium to large projects',
      fileName: 'onedrive-to-google-mydrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'onedrive-to-google-mydrive',
      planType: 'basic',
      keywords: ['basic', 'onedrive', 'google', 'mydrive', 'content', 'migration']
    },
    {
      name: 'ONEDRIVE TO GOOGLE MYDRIVE Standard',
      description: 'Standard template for OneDrive to Google MyDrive migration - suitable for large enterprise projects',
      fileName: 'onedrive-to-google-mydrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'onedrive-to-google-mydrive',
      planType: 'standard',
      keywords: ['standard', 'onedrive', 'google', 'mydrive', 'content', 'migration', 'enterprise']
    },
    // ONEDRIVE TO ONEDRIVE templates (Standard & Advanced only, Basic to be added later)
    {
      name: 'ONEDRIVE TO ONEDRIVE Basic',
      description: 'Basic template for OneDrive to OneDrive migration - suitable for medium to large projects',
      fileName: 'onedrive-to-onedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'onedrive-to-onedrive',
      planType: 'basic',
      keywords: ['basic', 'onedrive', 'content', 'migration']
    },
    {
      name: 'ONEDRIVE TO ONEDRIVE Standard',
      description: 'Standard template for OneDrive to OneDrive migration - suitable for large enterprise projects',
      fileName: 'onedrive-to-onedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'onedrive-to-onedrive',
      planType: 'standard',
      keywords: ['standard', 'onedrive', 'content', 'migration', 'enterprise']
    },
    // SHAREFILE TO GOOGLE MYDRIVE templates (Standard & Advanced only)
    {
      name: 'SHAREFILE TO GOOGLE MYDRIVE Basic',
      description: 'Basic template for ShareFile to Google MyDrive migration - suitable for medium to large projects',
      fileName: 'sharefile-to-google-mydrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharefile-to-google-mydrive',
      planType: 'basic',
      keywords: ['basic', 'sharefile', 'google', 'mydrive', 'content', 'migration']
    },
    {
      name: 'SHAREFILE TO GOOGLE MYDRIVE Standard',
      description: 'Standard template for ShareFile to Google MyDrive migration - suitable for large enterprise projects',
      fileName: 'sharefile-to-google-mydrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharefile-to-google-mydrive',
      planType: 'standard',
      keywords: ['standard', 'sharefile', 'google', 'mydrive', 'content', 'migration', 'enterprise']
    },
    // SHAREFILE TO GOOGLE SHARED DRIVE templates (Standard & Advanced only)
    {
      name: 'SHAREFILE TO GOOGLE SHARED DRIVE Basic',
      description: 'Basic template for ShareFile to Google Shared Drive migration - suitable for medium to large projects',
      fileName: 'sharefile-to-google-sharedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharefile-to-google-sharedrive',
      planType: 'basic',
      keywords: ['basic', 'sharefile', 'google', 'sharedrive', 'shared drive', 'content', 'migration']
    },
    {
      name: 'SHAREFILE TO GOOGLE SHARED DRIVE Standard',
      description: 'Standard template for ShareFile to Google Shared Drive migration - suitable for large enterprise projects',
      fileName: 'sharefile-to-google-sharedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharefile-to-google-sharedrive',
      planType: 'standard',
      keywords: ['standard', 'sharefile', 'google', 'sharedrive', 'shared drive', 'content', 'migration', 'enterprise']
    },
    // SHAREFILE TO ONEDRIVE templates (Standard & Advanced only)
    {
      name: 'SHAREFILE TO ONEDRIVE Basic',
      description: 'Basic template for ShareFile to OneDrive migration - suitable for medium to large projects',
      fileName: 'sharefile-to-onedrive-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharefile-to-onedrive',
      planType: 'basic',
      keywords: ['basic', 'sharefile', 'onedrive', 'microsoft', 'content', 'migration']
    },
    {
      name: 'SHAREFILE TO ONEDRIVE Standard',
      description: 'Standard template for ShareFile to OneDrive migration - suitable for large enterprise projects',
      fileName: 'sharefile-to-onedrive-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharefile-to-onedrive',
      planType: 'standard',
      keywords: ['standard', 'sharefile', 'onedrive', 'microsoft', 'content', 'migration', 'enterprise']
    },
    // SHAREFILE TO SHAREFILE templates (Standard & Advanced only)
    {
      name: 'SHAREFILE TO SHAREFILE Basic',
      description: 'Basic template for ShareFile to ShareFile migration - suitable for medium to large projects',
      fileName: 'sharefile-to-sharefile-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharefile-to-sharefile',
      planType: 'basic',
      keywords: ['basic', 'sharefile', 'content', 'migration']
    },
    {
      name: 'SHAREFILE TO SHAREFILE Standard',
      description: 'Standard template for ShareFile to ShareFile migration - suitable for large enterprise projects',
      fileName: 'sharefile-to-sharefile-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharefile-to-sharefile',
      planType: 'standard',
      keywords: ['standard', 'sharefile', 'content', 'migration', 'enterprise']
    },
    // SHAREFILE TO SHAREPOINT templates (Standard & Advanced only)
    {
      name: 'SHAREFILE TO SHAREPOINT Basic',
      description: 'Basic template for ShareFile to SharePoint migration - suitable for medium to large projects',
      fileName: 'sharefile-to-sharepoint-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharefile-to-sharepoint',
      planType: 'basic',
      keywords: ['basic', 'sharefile', 'sharepoint', 'microsoft', 'content', 'migration']
    },
    {
      name: 'SHAREFILE TO SHAREPOINT Standard',
      description: 'Standard template for ShareFile to SharePoint migration - suitable for large enterprise projects',
      fileName: 'sharefile-to-sharepoint-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'sharefile-to-sharepoint',
      planType: 'standard',
      keywords: ['standard', 'sharefile', 'sharepoint', 'microsoft', 'content', 'migration', 'enterprise']
    },
    // NFS TO GOOGLE templates (Standard & Advanced only, Basic to be added later)
    {
      name: 'NFS TO GOOGLE Basic',
      description: 'Basic template for NFS to Google (MyDrive/Shared Drive) migration - suitable for medium to large projects',
      fileName: 'nfs-to-google-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'nfs-to-google',
      planType: 'basic',
      keywords: ['basic', 'nfs', 'google', 'mydrive', 'sharedrive', 'content', 'migration']
    },
    {
      name: 'NFS TO GOOGLE Standard',
      description: 'Standard template for NFS to Google (MyDrive/Shared Drive) migration - suitable for large enterprise projects',
      fileName: 'nfs-to-google-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'nfs-to-google',
      planType: 'standard',
      keywords: ['standard', 'nfs', 'google', 'mydrive', 'sharedrive', 'content', 'migration', 'enterprise']
    },
    // EGNYTE TO GOOGLE templates (Standard & Advanced only, Basic to be added later)
    {
      name: 'EGNYTE TO GOOGLE Basic',
      description: 'Basic template for Egnyte to Google (Shared Drive / MyDrive) migration - suitable for medium to large projects',
      fileName: 'egnyte-to-google-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-google',
      planType: 'basic',
      keywords: ['basic', 'egnyte', 'google', 'sharedrive', 'mydrive', 'content', 'migration']
    },
    {
      name: 'EGNYTE TO GOOGLE Standard',
      description: 'Standard template for Egnyte to Google (Shared Drive / MyDrive) migration - suitable for large enterprise projects',
      fileName: 'egnyte-to-google-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-google',
      planType: 'standard',
      keywords: ['standard', 'egnyte', 'google', 'sharedrive', 'mydrive', 'content', 'migration', 'enterprise']
    },
    // EGNYTE TO MICROSOFT templates (Standard & Advanced only, Basic to be added later)
    {
      name: 'EGNYTE TO MICROSOFT Basic',
      description: 'Basic template for Egnyte to Microsoft (OneDrive/SharePoint) migration - suitable for medium to large projects',
      fileName: 'egnyte-to-microsoft-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-microsoft',
      planType: 'basic',
      keywords: ['basic', 'egnyte', 'microsoft', 'onedrive', 'sharepoint', 'content', 'migration']
    },
    {
      name: 'EGNYTE TO MICROSOFT Standard',
      description: 'Standard template for Egnyte to Microsoft (OneDrive/SharePoint) migration - suitable for large enterprise projects',
      fileName: 'egnyte-to-microsoft-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'egnyte-to-microsoft',
      planType: 'standard',
      keywords: ['standard', 'egnyte', 'microsoft', 'onedrive', 'sharepoint', 'content', 'migration', 'enterprise']
    },
    // NFS TO MICROSOFT templates (Standard & Advanced only, Basic to be added later)
    {
      name: 'NFS TO MICROSOFT Basic',
      description: 'Basic template for NFS to Microsoft (OneDrive/SharePoint) migration - suitable for medium to large projects',
      fileName: 'nfs-to-microsoft-standard.docx',
      isDefault: false,
      category: 'content',
      combination: 'nfs-to-microsoft',
      planType: 'basic',
      keywords: ['basic', 'nfs', 'microsoft', 'onedrive', 'sharepoint', 'content', 'migration']
    },
    {
      name: 'NFS TO MICROSOFT Standard',
      description: 'Standard template for NFS to Microsoft (OneDrive/SharePoint) migration - suitable for large enterprise projects',
      fileName: 'nfs-to-microsoft-advanced.docx',
      isDefault: false,
      category: 'content',
      combination: 'nfs-to-microsoft',
      planType: 'standard',
      keywords: ['standard', 'nfs', 'microsoft', 'onedrive', 'sharepoint', 'content', 'migration', 'enterprise']
    },
