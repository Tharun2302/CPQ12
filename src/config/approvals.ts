...
export const APPROVAL_TECH_EMAIL = 'abhilasha.kandakatla@cloudfuze.com';
export const APPROVAL_LEGAL_EMAIL = 'abhilasha.kandakatla@cloudfuze.com';
export const APPROVAL_DEALDESK_EMAIL = 'abhilasha.kandakatla@cloudfuze.com';
