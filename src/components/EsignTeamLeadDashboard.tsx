          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center">
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <h1 className="text-4xl font-bold text-gray-900">E-Sign Team Lead Dashboard</h1>
              </div>
              <p className="text-xl text-gray-600">Team lead e-signature: sign or review documents (fixed roles: Team → Tech → Legal → Deal Desk)</p>
